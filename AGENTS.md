...
This project is indexed by GitNexus as **interview** (2767 symbols, 8514 relationships, 234 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
