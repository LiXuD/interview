...
This project is indexed by GitNexus as **interview** (4058 symbols, 13048 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
